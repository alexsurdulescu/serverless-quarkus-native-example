...
@QuarkusTest
@TestProfile(HelloTestProfile::class)
open class HelloLambdaHandlerTest {
    @Test
    ...
    fun testSimpleLambdaSuccess() {
        ...
        RestAssured.given()
            ...
            .then()
            .statusCode(200)
            .body(CoreMatchers.containsString("Hello Alex"))
    }
}

class HelloTestProfile : QuarkusTestProfile {
    override fun getConfigOverrides(): MutableMap<String, String> {
        return mutableMapOf("quarkus.lambda.handler" to "hello")
    }
}
